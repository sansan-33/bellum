...
public class CardLayout : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (cardindex == 6) { this.GetComponent<RectTransform>().anchoredPosition = new Vector3(-100, y, 0); }
        if (cardindex == 7) { this.GetComponent<RectTransform>().anchoredPosition = new Vector3(-200, y, 0); }
    }
